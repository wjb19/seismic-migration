function [Summary, finalTrace, srcX, srcY, recX, recY] = ktmWriteTraceBlockSortedOffset(file,range,opt,en,sze)

% function [Summary] = ktmWriteTraceBlockSortedOffset(file,range,opt,en,sze)
%
...
%
% 
% EXAMPLE: ktmWriteTraceBlockSortedOffset('salt.c3na-b.segy',[1,10000],1,'ieee-be',32)
% USES: ktmGetInputMeta, ktmGetInputTrace.m
%
% SEE ALSO: ktmListInputMeta.m, ktmVisualizeInput.m
%
% written/tested WJB 02/11 Linux CentOS
...
disp('Sort Traces According to h');
[metaDataH, tracesH]=ktmGetSortedOffTraces(metaData,traces);
